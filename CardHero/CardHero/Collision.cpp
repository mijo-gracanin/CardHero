...
namespace Collision
{
	...
	sf::Vector2f GetSpriteCenter (const sf::RectangleShape& Object)
	{
		sf::FloatRect AABB = Object.getGlobalBounds();
		return sf::Vector2f (AABB.left+AABB.width/2.f, AABB.top+AABB.height/2.f);
	}

	sf::Vector2f GetSpriteSize (const sf::RectangleShape& Object)
	{
	...
	bool CircleTest(const sf::RectangleShape& Object1, const sf::RectangleShape& Object2) {
